...
Example usage:
    python3.6 object_detection/dataset_tools/create_coco_tf_record.py --logtostderr \
      --train_image_dir="object_detection/dataset_tools/train" \
      --val_image_dir="object_detection/dataset_tools/valid" \
      --test_image_dir="object_detection/dataset_tools/test" \
      --train_annotations_file="object_detection/dataset_tools/train.json" \
      --val_annotations_file="object_detection/dataset_tools/valid.json" \
      --testdev_annotations_file="object_detection/dataset_tools/test.json" \
      --output_dir="object_detection/dataset"
"""
